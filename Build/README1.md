Here is the complete source code for the three main services that make up the C500 Collective architecture.
        ...
        async with aiohttp.ClientSession() as session:
            ...
            async with session.post(f"{GO_API_URL}/create-checkout", json=payload) as resp:
                if resp.status == 200:
                    ...
                    await interaction.followup.send(embed=embed, view=link_vie
